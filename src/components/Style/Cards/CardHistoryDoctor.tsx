...
import ModalRecordDoctor from "../../Main/ModalRecord/modalRecordDoctor.tsx";
...
interface CardProps {
  ...
  district: string;
  city: string;
  history: MedicalRecordDataPatient["history"];
  number: string;
}

const CardHistoryDoctor: React.FC<CardProps> = ({
  id,
  type,
  query,
  patientName,
    ...
    >
      <Flex direction="column">
        ...
        <Flex direction="column" mt={2}>
          ...
          {/* Continue com as outras propriedades do history */}
        </Flex>
      </Flex>
      ...
      <Modal isOpen={isOpen} onClose={handleCloseModal} size="xl">
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>
            <ModalRecordDoctor key={id} historyData={history} />
          </ModalBody>
        </ModalContent>
      </Modal>
    </Box>
...
export default CardHistoryDoctor;
